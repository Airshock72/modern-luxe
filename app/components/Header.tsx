          ...
          <div className='flex lg:flex-1'>
            <Link href='#'>
              <Image
                ...
                alt='modern luxe logo'
                width={250}
                height={80}
                className='w-50 lg:w-62.5'
              />
            </Link>
          </div>
          ...
          <div className='mt-6 flow-root'>
            <div className='-my-6 divide-y divide-gray-500/10'>
              <div className='space-y-4 py-6'>
                <Link
                  href='#'
                  className='-mx-1 rounded-sm block px-3 py-2 text-base/7 font-semibold text-white bg-gray-700/80 hover:bg-gray-200 hover:text-primary'
                >Features
                </Link>
                <Link
                  href='#'

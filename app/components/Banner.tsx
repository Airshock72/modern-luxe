        ...
        <div className="bg-[url('/modern-luxe/assets/banner.jpg')] bg-cover bg-center min-h-[70vh] h-125 md:h-svh flex items-center relative">
          ...
          bg-[#777F88]/20 p-3 lg:p-4 xl:p-5 2xl:p-6 rounded-2xl shadow-lg'>
            <div className='relative w-62.5 lg:w-70 xl:w-[320px] 2xl:w-350px] h-32 lg:h-44 xl:h-48 2xl:h-50 rounded-lg overflow-hidden shadow-2xl'>
              ...
              <div className='absolute inset-0 flex items-center justify-center'>
                <div className='bg-white/20 backdrop-blur-sm rounded-full p-2 md:p-5 hover:bg-white/30 transition-all cursor-pointer'>
                  <svg
          ...
          <div className='container mx-auto px-4 lg:px-6 xl:px-8 2xl:px-12 pt-20 lg:pt-24 xl:pt-32 2xl:pt-40'>
            <div className='grid grid-cols-1 items-center justify-items-center text-white'>
              <div className='space-y-3 md:space-y-4 lg:space-y-5 xl:space-y-6 2xl:space-y-5 -mt-30 sm:-mt-30 md:-mt-50 lg:-mt-50 xl:-mt-60 2xl:-mt-80 text-center
              lg:text-left max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl'>
                ...
                <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[8rem] leading-tight font-bold'>
                  COMFORT
                </h1>
                <p className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl max-w-xs sm:max-w-sm
                 md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto lg:mx-0 px-2 sm:px-4 lg:px-0'>
